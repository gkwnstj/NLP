...
def main(args):
	...
	mylstm_enc = lstm_example.CustomLSTM(args.hidden_size, args.hidden_size, args.num_layers)
	mylstm_dec = lstm_example.CustomLSTM(args.hidden_size*2, args.hidden_size, args.num_layers)

	encoder = lstm_example.Encoder(mylstm_enc,len(vocab_src), args.hidden_size, num_layers=args.num_layers)

	attn = lstm_example.Attention(args.hidden_size, args.hidden_size)
	
	decoder = lstm_example.Decoder(mylstm_dec, attn, len(vocab_tgt), args.hidden_size, num_layers=args.num_layers)
